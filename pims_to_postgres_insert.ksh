...
python pims_to_postgres_insert.py > log/pims_to_postgres_insert.txt
...
Load End time : $end_time"  ; uuencode /apps/opt/application/pscmigration/1pscmigration/scripts/phase1_extract/bin/log/pims_to_postgres_insert.txt pims_to_postgres_insert.txt) | mailx -s "Status of Extraction of PIMS and WFM Tables into Postgres tables for PIMS Snapshot  at $subject_time  on $subject_date" $emails
echo "Sent mail."
